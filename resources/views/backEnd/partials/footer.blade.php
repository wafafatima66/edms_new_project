...
<script src="{{asset('public/assets/js/amcharts/amcharts.js')}}"></script>
...
<!-- <script src="{{asset('public/assets/js/amcharts/export.min.js')}}"></script> -->
...
<script src="{{asset('public/assets/pages/data-table/js/jszip.min.js')}}"></script>
<script src="{{asset('public/assets/pages/data-table/js/pdfmake.min.js')}}"></script>
<script src="{{asset('public/assets/pages/data-table/js/vfs_fonts.js')}}"></script>
<script src="{{asset('public/assets/pages/data-table/extensions/buttons/js/dataTables.buttons.min.js')}}"></script>
<script src="{{asset('public/assets/pages/data-table/extensions/buttons/js/buttons.flash.min.js')}}"></script>
<script src="{{asset('public/assets/pages/data-table/extensions/buttons/js/jszip.min.js')}}"></script>
<script src="{{asset('public/assets/pages/data-table/extensions/buttons/js/vfs_fonts.js')}}"></script>
<script src="{{asset('public/assets/pages/data-table/extensions/buttons/js/buttons.colVis.min.js')}}"></script>
...
<script src="{{asset('public/assets/pages/data-table/extensions/buttons/js/extension-btns-custom.js')}}"></script>
<!-- end for datatable js -->


<!-- start for select2 dropdown -->
...
<script type="text/javascript" src="{{asset('public/bower_components/multiselect/js/jquery.multi-select.js')}}">
</script>
<script type="text/javascript" src="{{asset('public/assets/js/jquery.quicksearch.js')}}">
</script>
...
<script type="text/javascript" src="{{asset('public/js/developer.js')}}"></script>
<!-- End of gautam added script -->
