	...
	<div class="col-md-4">
       ...
       <div class="row">
        ...
        <div class="form-group col-md-12">
          <label for="type_name">Application Type</label>
...
<div class="col-md-8">
  <div class="row">
    <div class="col-lg-12">
       <a href="{{url('preview_doc', $editData->id)}}" class="pull-right  btn btn-primary m-b-0">Refresh</a>
    </div>
         ...
         if(countryID)
         {
          jQuery.ajax({
           ...
           success:function(data)
           {
            ...
            $('select').append('<option value="">Select Document Type</option>');
