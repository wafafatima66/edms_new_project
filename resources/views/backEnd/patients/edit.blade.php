				...
				<div class="col-md-12 pt-4">
					<div class="row">
						...
						<label for="title">Title: <span class="required"> (*) </span></label>
				  		<select class="js-example-basic-single col-sm-12 {{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" id="title">
				  			

				  			<option value="Mr"
				  			@if(isset($editData))
				  			@if($editData->title == 'Mr')
				  			selected
				  			@endif 
				  			@endif
				  			>Mr</option>
