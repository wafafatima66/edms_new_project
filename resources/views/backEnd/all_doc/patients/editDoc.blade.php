...
<div class="card">
	<div class="card-header">
		...
		<a class="btn btn-success mr-3 pull-right" href="{{ url('doc_list/'.session()->get('doc_id').'/'.session()->get('doc_type') ) }}" >Back</a>
	...
	<div class="card-block">
		...
		<div class="form-group row mt-5">
			<div class="col-sm-8 offset-md-2 text-center">
				<a class="col-md-2 btn btn-danger mr-3" href="{{ url('doc_list/'.session()->get('doc_id').'/'.session()->get('doc_type') ) }}">Cancel</a>
