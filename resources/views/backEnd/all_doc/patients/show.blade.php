...
<div class="card">
    <div class="card-header">
        <h5>Document Type  
        {{-- @if(isset($type)){{$type}}@endif --}}
        </h5>
		<a class="btn btn-success mr-3 pull-right" href="{{ url('application_type/'.$type) }}" >Back</a>
        ...
        <table id="basic-btn" class="table table-striped table-bordered nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> @php 
                        echo App\ErpConsultant::where('id','=',$doc->consultant)->value('name');
                    @endphp</td>
                    <td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
                        ...
                        <!-- <a href="{{url('doc-type/edit/'.$doc->id)}}" title="Properties"><button type="button" class="btn btn-info action-icon"><i class="fa fa-edit"></i></button></a> -->
